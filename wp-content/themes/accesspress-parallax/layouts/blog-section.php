...
?>
	...
	<?php 
		...
		<a href="<?php the_permalink(); ?>" class="blog-list wow fadeInDown" data-wow-delay="<?php echo $i; ?>s">
			...
			<span><?php _e('Читати далі','accesspress-parallax') ?>&nbsp;&nbsp;<i class="fa fa-angle-right"></i></span>
			</div>
		</a>
	...
	<a class="btn" href="<?php echo get_category_link($category)?>"><?php _e('Читати всі новини','accesspress-parallax'); ?></a>
	</div>